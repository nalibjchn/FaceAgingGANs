...
#na li updated and added begin
flags.DEFINE_string("pretrained_checkpoint_dir", './checkpoints/0_conv5_lsgan_transfer_g75_0.5f-4_a30/',
...
def my_test():
    with tf.Graph().as_default():
        ...
        if model.load(FLAGS.pretrained_checkpoint_dir, model.saver, 'acgan', 399999):
            print(" [*] Load SUCCESS")
        else:
            print(" [!] Load failed...")
