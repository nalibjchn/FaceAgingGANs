"""Face_age_Estimator.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qFnrIL3zJ54DSJYzIWBhRcntIvVcEKrk
"""
...
"""
    ...
    x = Dropout(0.5)(x)
    x = Conv2D(101, (1,1),name="prediction")(x)
    ...
    faceage_vgg_model.compile(loss='categorical_crossentropy', \
                              optimizer=Adam(), \
                              metrics=['accuracy'])

    for layer in faceage_vgg_model.layers:
    ...
    #epochs = 501
    #batch_size = 256
    score = faceage_vgg_model.fit(train_x, train_y, \
                              batch_size=128,\
                              epochs=300,\
                              validation_data=(test_x, test_y), \
                              callbacks=[checkpointer, loss_track])
    faceage_vgg_model = load_model("age_model.h5")   
    faceage_vgg_model.save_weights('age_model_weights.h5')
    print("training done!!")
